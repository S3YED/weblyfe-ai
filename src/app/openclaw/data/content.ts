...
export const TIERS = [
  {
    ...
    price: '€65',
    priceNote: 'one-time',
    description: 'The complete 62-page playbook to build your own AI employee. Real code, real prompts, real results.',
    featured: true,
    light: true,
    items: [
      '62-page PDF setup guide',
      'The 3-Layer Architecture explained',
      'Self-Annealing Loop framework',
      'Copy-paste ready prompts',
      'Full cost breakdown ($45/month)',
      'Airtable + n8n integration patterns',
      'Lifetime updates',
    ],
    package: 'diy',
    cta: 'Get the Guide Now',
    ctaHref: 'https://buy.stripe.com/7sYaEYfAn30C8BncwJ3Je2I',
  },
  {
    tag: 'COMING SOON',
    title: 'Instant Appie',
