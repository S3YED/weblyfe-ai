...
const caseStudies: Record<string, {
  ...
  'safesite-security': {
    ...
    stats: [
      ...
      { label: 'Meetings Required', value: '0' },
      { label: 'Live Same Day', value: '100%' },
    ],
  ...
  'bot-farm-defense': {
    ...
    stats: [
      { label: 'Reviews Removed', value: '9' },
      { label: 'Faster Analysis', value: '96%', before: '2 days → 2 hrs' },
      { label: 'Evidence Points', value: '50+' },
    ],
  ...
  'privanotify': {
    ...
    stats: [
      ...
      { label: 'Messages Sent', value: '1000+' },
    ],
  ...
  'legal-email-automation': {
    ...
    stats: [
      ...
      { label: 'Follow-ups', value: '100% Auto' },
    ],
  ...
  'boooth-booking': {
    ...
    stats: [
      ...
      { label: 'Booking Available', value: '24/7' },
  ...
  'titan-transfers': {
    ...
    stats: [
      { label: 'Mobile Bookings', value: '100%' },
